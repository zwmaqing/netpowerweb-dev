  ...
  <div class="login-wrap">
    ...
    <div class="ms-login">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm">
        ...
        <p style="font-size:12px;line-height:20px;color:#999;padding-top: 5px;">{{notice}}
          <el-button size="mini" icon="el-icon-question" @click="gotohelp"></el-button>
        </p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      gotohelp() {
        window.open("http://netbroadbook.oss-cn-hangzhou.aliyuncs.com/Index.html"); //在另外新建窗口中打开窗口
      }
    },
    computed: {
      ...mapGetters({
